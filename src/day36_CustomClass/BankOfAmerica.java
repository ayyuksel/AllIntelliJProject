...
public class BankOfAmerica {//object class

    //HAS A:
    //Bank of America has an employee
    public static void main(String[] args) {
        ...
        employees[0].setInfo("Ayse Yuksel", 'F', "Developer", companyName, 400_000, "0001", LocalDate.of(2021, 04, 01));
        //employees [0].getInfo();
        ...
        // removes the employees IF job title of the employee is not SDET nor  Developer
        ...
        System.out.println("==================================");
        //int maxSalary=employees[0].salary;you cannot assign primitive to Employee Class
